...
/**
 * Allowed gap values, currently represnting multiples of 0.25rem in CSS.
 *
...
const Box = forwardRef(
  (
    { children, horizontal = false, gap = 2, ...attributeProps }: BoxProps,
    ...
    return (
      <div className={className} ref={ref} {...attributeProps}>
        {children}
      </div>
    );
  }
